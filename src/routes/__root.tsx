...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Nutrient Navigator Project" },
      { name: "author", content: "Admin" },
      { property: "og:title", content: "Nutrient Navigator" },
      { property: "og:description", content: "Nutrient Navigator Project" },
      { name: "twitter:site", content: "@NutrientNavigator" },
    ],
    links: [
